...
namespace xSuper\OqexPractice\libs\_5bc4ae2005dd3233\poggit\libasynql\base;
...
use xSuper\OqexPractice\libs\_5bc4ae2005dd3233\poggit\libasynql\generic\GenericStatementFileParser;
use xSuper\OqexPractice\libs\_5bc4ae2005dd3233\poggit\libasynql\GenericStatement;
...
class DataConnectorImpl implements DataConnector{
	...
	private function executeImpl(string $queryName, array $args, int $mode, callable $handler, ?callable $onError) : void{
		...
		$modes = array_fill(0, count($queries), $mode);
